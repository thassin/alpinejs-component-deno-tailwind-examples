...
import type * as Globals from './Global.ts';

// TODO is it possible to combine these to a one single import statement?
// => so can you combine "import type" and "import" to a same statement?
import type * as Impl from './Component.ts';
import { AlpineComponent, type AlpineComponentConstructor } from './Component.ts';
