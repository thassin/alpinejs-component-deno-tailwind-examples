...
export abstract class AlpineComponent implements AlpineDataContext {
	 ...
	 */
//	declare $data: this;
// 20250129 alpine sub-components inherit the parent-component data context.
// => so the $data typing is complicated, is it better to leave this out on this level?
